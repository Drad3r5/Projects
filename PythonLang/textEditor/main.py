...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    self.settitle()
    # Creating Statusbar
    self.statusbar = Label(self.root,textvariable=self.status,font=("Monospace",15,"bold"),bd=2,relief=GROOVE)
    # Packing status bar to root window
    self.statusbar.pack(side=BOTTOM,fill=BOTH)
    # Initializing Status
    self.status.set("Welcome To PyEditor")
    # Creating Menubar
    self.menubar = Menu(self.root,font=("Monospace",15,"bold"),activebackground="skyblue")
    # Configuring menubar on root window
    self.root.config(menu=self.menubar)
    # Creating File Menu
    self.filemenu = Menu(self.menubar,font=("Monospace",12,"bold"),activebackground="skyblue",tearoff=0)
    ...
    # Creating Edit Menu
    self.editmenu = Menu(self.menubar,font=("Monospace",12,"bold"),activebackground="skyblue",tearoff=0)
    ...
    # Creating Help Menu
    self.helpmenu = Menu(self.menubar,font=("Monospace",12,"bold"),activebackground="skyblue",tearoff=0)
  ...
  def infoabout(self):
    ...
    messagebox.showinfo("Links","Github\nhttps://github.com/Drad3r5\n")
